...
>
    ...
    <div class="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl text-center">
            <p data-reveal class="glass mb-4 inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-medium uppercase tracking-wider text-cyan-300">
                Showcase
            </p>
        ...
        <div class="mx-auto mt-16 max-w-6xl grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
            ...
            @else
                @foreach ($placeholders as $i => $item)
                    <div data-reveal data-reveal-delay="{{ ($i % 4) + 1 }}" class="group relative overflow-hidden rounded-2xl">
        ...
        <div data-reveal data-reveal-delay="2" class="mt-12 text-center">
            <a
