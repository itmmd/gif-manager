@php
    ...
    // Inline SVG path data per social icon slug
    $socialIcons = [
    ...
    // 'Account' column is built from named routes (auth-gated entries kept inline)
    $accountLinks = [
...
>
    ...
    <div class="max-w-6xl mx-auto px-6 pt-16 pb-10">
        ...
        <div class="grid grid-cols-2 gap-10 sm:grid-cols-2 lg:grid-cols-4 mb-14">
            ...
            {{-- Col 3: Account (named routes + auth-gated dashboard) --}}
